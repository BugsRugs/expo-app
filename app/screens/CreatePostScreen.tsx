...
import { storeLocation, retrieveLocation } from '../../utils/hooks/locationUtils';
  ...
  return (
    <ScrollView>
      <View style={{flex: 1, alignItems: 'center'}}>
        ...
        {/* <TouchableOpacity onPress={postFunction()} style={{  backgroundColor: '#40E0D0', padding: 10, borderRadius: 5, margin: 10, paddingVertical: 10}}>
        <Text onPress={savePostFunction} style={styles.postText}>Save Post!</Text>
        </TouchableOpacity> */}
        <SavePost
